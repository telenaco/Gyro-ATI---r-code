...
ggplot() +
  ...
  geom_line(data=subGyro1, aes( x=millis ,y=radPitch), color='green', linetype = "dashed")+
  ggtitle("X Torque")+
...
p1 <-  ggplot() +
  geom_line(data=subGyro1, aes( x=millis ,y=degPitch), color='green', linetype = "dashed")
